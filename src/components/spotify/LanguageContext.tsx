...
const en = {
  ...
  wrappedTitle1: "Max shipped all year.",
  wrappedTitle2: "Now it's your turn to run.",
  wrappedSubtitle: "11 projects · 2 hackathons · 1 SaaS exited - dodge the bugs like Max did. Press",
  ...
  score: "Score",
  best: "Best",
  congrats: "Well played! 🎉 Share your score with Max on LinkedIn",
  shareOnLinkedin: "Message Max on LinkedIn",
  yourName: "Your name",
  ...
  tourWelcomeTitle: "Welcome to Max's Portfolio 🎧",
  tourWelcomeText:
  ...
  tourFeaturedText:
    "That's Max! Visit the artist page for the About section, highlights, and the full discography.",
...
const fr: Dict = {
  ...
  wrappedBannerText:
    "Joue au dino runner, évite les bugs et cumule les streams en découvrant l'année de Max.",
  wrappedBannerCta: "Jouer au mini-jeu",
  wrappedTitle1: "Max a shippé toute l'année.",
  wrappedTitle2: "À toi de courir maintenant.",
  wrappedSubtitle: "11 projets · 2 hackathons · 1 SaaS vendu - évite les bugs comme Max. Appuie sur",
  ...
  score: "Score",
  best: "Record",
  congrats: "Bien joué ! 🎉 Partage ton score à Max sur LinkedIn",
  shareOnLinkedin: "Écrire à Max sur LinkedIn",
  yourName: "Ton nom",
  ...
  tourWelcomeTitle: "Bienvenue sur le portfolio de Max 🎧",
  tourWelcomeText:
  ...
  tourFeaturedText:
    "C'est Max ! Visite la page artiste pour la section À propos, les highlights et toute la discographie.",
